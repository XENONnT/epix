...
from .common import awkward_to_flat_numpy, ak_num, calc_dt, reshape_awkward
import epix #Remove this and do a proper import of the functions!
...
class cluster_merging(strax.Plugin):
    ...
    def full_array_to_numpy(self, array):
        ...
        array_structure = np.array(ak_num(array["x"]))
