...
class BBF_quanta_generator:
    def __init__(self):
        ...
        self.nr_par_dict = {
            "W": 0.01375971689855625,
            "Nex/Ni": 0.13097125617044109,
            "alpha": 1.2693749541701738,
            "zeta": 0.047109705184996895,
            "beta": 240.3649701916462,
            "gamma": 0.013310460291490182,
            "delta": 0.06297836439231688,
            "kappa": 0.13530750791366353,
            "eta": 3.326165546055348,
            "lambda": 1.08299501303259,
            'fano' : 0.059
        }
        self.ERs = [7,8,11]
        self.NRs = [0,1]
