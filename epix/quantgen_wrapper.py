...
class BBF_quanta_generator:
    def __init__(self):
        ...
        self.nr_par_dict = {
            "W": 0.013700236688527061,
            "Nex/Ni": 0.13097125617044109,
            "alpha": 1.1601699317551273,
            "zeta": 0.05260837710260018,
            "beta": 238.52228637169424,
            "gamma": 0.014343046161413336,
            "delta": 0.05880168731075577,
            "kappa": 0.13910687867135166,
            "eta": 3.378155827881945,
            "lambda": 1.3366230264139476,
            'fano' : 0.059
        }
        self.ERs = [7,8,11]
        self.NRs = [0,1]
